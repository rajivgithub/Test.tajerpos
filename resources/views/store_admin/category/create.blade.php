                                ...
                                @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="mb-4 input-field-div">
                                                <label class="form-label">{{ __('store-admin.category_url') }}<span>*</span></label>
                                                <input type="text" placeholder="{{ __('store-admin.category_name_placeholder') }}"  data-max="100" data-label = "{{ __('store-admin.category_url') }}" name="category_url" class="form-control required-field form-input-field" data-pattern="^[A-Za-z0-9\-]*$" data-error-msg="{{ __('validation.invalid_url_err') }}" onkeypress="return restrictCharacters(event)" value="{{!empty($category_details) && !empty($category_details[0]->category_url) ? $category_details[0]->category_url : '' }}">
                                                @if ($errors->has('category_url'))
                                                    <span class="text-danger error-message">{{ $errors->first('category_url') }}</span>
                                                @endif
                                                <span class="error error-message"></span>
                                            </div>
